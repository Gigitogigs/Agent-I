...
import backend.db.models  # This ensures all models are registered in Base.metadata

# add your model's MetaData object here
# for 'autogenerate' support
target_metadata = Base.metadata

# Override the sqlalchemy.url in alembic.ini with the one from our settings
# configparser treats % as interpolation. We must escape it as %% for alembic.
